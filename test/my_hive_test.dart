...
import 'package:chat2you/app/data/local/my_hive.dart';
import 'package:chat2you/app/data/models/user_model.dart';
  ...
  group('hive save, read, and delete test', () {
    test('write on hive', () async {
      ...
      bool saved = await MyHive.saveUserToHive(UserModel.fromData(
          age: 24, phoneNumber: '+5535984036852', username: 'Anderson André'));
      expect(saved, true);
    });
