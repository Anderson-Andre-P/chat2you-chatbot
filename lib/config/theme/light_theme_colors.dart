...
class LightThemeColors {
  ...
  static const Color dividerColor = Color(0xffBEBEBE);
  static const Color cardColor = Color(0xffF7F7F7);

  // ICONS
  static const Color appBarIconsColor = Colors.white;
  static const Color iconColor = Color(0xFF536471);
  ...
  // TEXT
  static const Color bodyTextColor = Color(0xFF6C6C6C);
  static const Color displayTextColor = Color(0xFF0F1419);
